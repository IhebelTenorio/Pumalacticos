...
/**
 * Clase que representa una pizza de ingrediente de carnes que esta extendida de la clase PrepararPizza
 * implementando los pasos de preparación de una pizza comun
 */
public class Carnes extends PrepararPizza{
    private String sabor = "Carnes";
    private String masa;

    /**
     * Crea una pizza con carnes, en base a una masa elegida
     * @param masa El tipo de masa que se usara para la pizza
     */
    public Carnes(String masa){
        this.masa = masa;
    }
    ...
    protected void colocarProteina(){
        System.out.println("Colocando las carnes");
    }
